...
import { useGetPopularMoviesQuery, useSearchMoviesQuery, useGetGenresQuery } from "../store/api";
...
const MovieList = () => {
  ...
  const { data: searchResults, isLoading: searchLoading, error: searchError } = useSearchMoviesQuery(
